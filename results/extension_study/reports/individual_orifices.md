# Independent orifice demonstration (not an optimized design)

# Configuration
```yaml
name: Independent orifice demonstration (not an optimized design)
rack:
  compute_trays: 18
  switch_trays: 9
  layout:
...
| CV_flow | 0.2613171 |
| M_thermal | 1.208241 |
| RMS_target_error | 0.721598 |
| max_abs_target_error | 1.303391 |
| zero_load_flow_fraction | 0 |
| T_out_max_C | 59.26466 |
| T_out_min_C | 45.96483 |
| outlet_spread_K | 13.29983 |
| rack_dp_Pa | 82563.51 |
| system_dp_Pa | 82563.51 |
| rack_flow_LPM | 120 |
| heat_W | 115560 |
| T_return_C | 53.72642 |
| rack_deltaT_K | 13.72642 |
| pump_hydraulic_W | 165.127 |
| pump_electrical_W | 275.2117 |
...
| minimum_normalized_margin | -0.1632332 |
| T_junction_upper_max_C | 83.26466 |
...
| --- | --- | --- | --- |
| coldplates | 44906.76 | 44.907 | 54.39 |
| qdcs | 17041.50 | 17.041 | 20.64 |
| tubing | 8608.23 | 8.608 | 10.43 |
| fittings | 6474.62 | 6.475 | 7.84 |
| valves | 462.47 | 0.462 | 0.56 |
| restrictions | 0.00 | 0.000 | 0.00 |
| orifices | 1778.51 | 1.779 | 2.15 |
| header_friction | 835.49 | 0.835 | 1.01 |
| header_minor | 2393.11 | 2.393 | 2.90 |
...
| --- | --- | --- | --- | --- | --- |
| C01 | 5800.0 | 4.2885 | 6.0228 | 59.265 | 19.265 |
| C02 | 5800.0 | 5.3657 | 6.0228 | 55.404 | 15.404 |
| C03 | 5800.0 | 5.3550 | 6.0228 | 55.435 | 15.435 |
| C04 | 5800.0 | 5.3453 | 6.0228 | 55.463 | 15.463 |
| C05 | 5800.0 | 5.3365 | 6.0228 | 55.488 | 15.488 |
| C06 | 5800.0 | 5.3286 | 6.0228 | 55.511 | 15.511 |
| C07 | 5800.0 | 5.3215 | 6.0228 | 55.532 | 15.532 |
| C08 | 5800.0 | 5.3151 | 6.0228 | 55.551 | 15.551 |
| C09 | 5800.0 | 5.3095 | 6.0228 | 55.567 | 15.567 |
| S01 | 1240.0 | 1.9407 | 1.2876 | 49.112 | 9.112 |
| S02 | 1240.0 | 2.9659 | 1.2876 | 45.965 | 5.965 |
| S03 | 1240.0 | 2.9635 | 1.2876 | 45.970 | 5.970 |
| S04 | 1240.0 | 2.9613 | 1.2876 | 45.974 | 5.974 |
| S05 | 1240.0 | 2.9592 | 1.2876 | 45.978 | 5.978 |
| S06 | 1240.0 | 2.9573 | 1.2876 | 45.982 | 5.982 |
| S07 | 1240.0 | 2.9556 | 1.2876 | 45.986 | 5.986 |
| S08 | 1240.0 | 2.9540 | 1.2876 | 45.989 | 5.989 |
| S09 | 1240.0 | 2.9526 | 1.2876 | 45.992 | 5.992 |
| C10 | 5800.0 | 5.2739 | 6.0228 | 55.672 | 15.672 |
| C11 | 5800.0 | 5.2720 | 6.0228 | 55.678 | 15.678 |
| C12 | 5800.0 | 5.2705 | 6.0228 | 55.682 | 15.682 |
| C13 | 5800.0 | 5.2694 | 6.0228 | 55.685 | 15.685 |
| C14 | 5800.0 | 5.2685 | 6.0228 | 55.688 | 15.688 |
| C15 | 5800.0 | 5.2679 | 6.0228 | 55.690 | 15.690 |
| C16 | 5800.0 | 5.2675 | 6.0228 | 55.691 | 15.691 |
| C17 | 5800.0 | 5.2672 | 6.0228 | 55.692 | 15.692 |
| C18 | 5800.0 | 5.2670 | 6.0228 | 55.693 | 15.693 |

# Pump requirements
Rack 82.564 kPa; system 82.564 kPa; hydraulic 165.13 W; electrical 275.21 W.
...
| --- | --- | --- | --- |
| CDU_external_head | 32436.5 | Pa | True |
| pump_curve | 32436.5 | Pa | True |
| rack_flow | 10 | LPM | True |
| CDU_aggregate_flow | 0 | LPM | True |
| supply_temperature | 5 | K | True |
| return_temperature | 11.2736 | K | True |
| branch_outlet | 5.73534 | K | True |
| minimum_thermal_flow | 0.0167643 | kg/s | True |
...
| chip_assumed_target | -3.26466 | K | False |
...
| nfev | 378 |
| temperature_error_K | 7.900067976152059e-05 |
| flow_relative_error | 3.056160949472173e-08 |
| converged | True |
...
| --- | --- | --- | --- | --- |
| C01 | GPU | 71.26 | 83.26 | -3.26 |
| C01 | CPU | 69.26 | 79.26 | 0.74 |
| C02 | GPU | 67.4 | 79.4 | 0.6 |
| C02 | CPU | 65.4 | 75.4 | 4.6 |
| C03 | GPU | 67.44 | 79.44 | 0.56 |
| C03 | CPU | 65.44 | 75.44 | 4.56 |
| C04 | GPU | 67.46 | 79.46 | 0.54 |
| C04 | CPU | 65.46 | 75.46 | 4.54 |
| C05 | GPU | 67.49 | 79.49 | 0.51 |
| C05 | CPU | 65.49 | 75.49 | 4.51 |
| C06 | GPU | 67.51 | 79.51 | 0.49 |
| C06 | CPU | 65.51 | 75.51 | 4.49 |
| C07 | GPU | 67.53 | 79.53 | 0.47 |
| C07 | CPU | 65.53 | 75.53 | 4.47 |
| C08 | GPU | 67.55 | 79.55 | 0.45 |
| C08 | CPU | 65.55 | 75.55 | 4.45 |
| C09 | GPU | 67.57 | 79.57 | 0.43 |
| C09 | CPU | 65.57 | 75.57 | 4.43 |
| S01 | NVSwitch | 58.41 | 70.81 | 9.19 |
| S02 | NVSwitch | 55.26 | 67.66 | 12.34 |
| S03 | NVSwitch | 55.27 | 67.67 | 12.33 |
| S04 | NVSwitch | 55.27 | 67.67 | 12.33 |
| S05 | NVSwitch | 55.28 | 67.68 | 12.32 |
| S06 | NVSwitch | 55.28 | 67.68 | 12.32 |
| S07 | NVSwitch | 55.29 | 67.69 | 12.31 |
| S08 | NVSwitch | 55.29 | 67.69 | 12.31 |
| S09 | NVSwitch | 55.29 | 67.69 | 12.31 |
| C10 | GPU | 67.67 | 79.67 | 0.33 |
| C10 | CPU | 65.67 | 75.67 | 4.33 |
| C11 | GPU | 67.68 | 79.68 | 0.32 |
| C11 | CPU | 65.68 | 75.68 | 4.32 |
| C12 | GPU | 67.68 | 79.68 | 0.32 |
| C12 | CPU | 65.68 | 75.68 | 4.32 |
| C13 | GPU | 67.69 | 79.69 | 0.31 |
| C13 | CPU | 65.69 | 75.69 | 4.31 |
| C14 | GPU | 67.69 | 79.69 | 0.31 |
| C14 | CPU | 65.69 | 75.69 | 4.31 |
| C15 | GPU | 67.69 | 79.69 | 0.31 |
| C15 | CPU | 65.69 | 75.69 | 4.31 |
| C16 | GPU | 67.69 | 79.69 | 0.31 |
| C16 | CPU | 65.69 | 75.69 | 4.31 |
| C17 | GPU | 67.69 | 79.69 | 0.31 |
| C17 | CPU | 65.69 | 75.69 | 4.31 |
| C18 | GPU | 67.69 | 79.69 | 0.31 |
| C18 | CPU | 65.69 | 75.69 | 4.31 |
