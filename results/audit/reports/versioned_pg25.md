...
| CV_flow | 0.2444608 |
| M_thermal | 1.057586 |
| RMS_target_error | 0.7350666 |
| max_abs_target_error | 1.265635 |
| zero_load_flow_fraction | 0 |
| T_out_max_C | 56.70677 |
| T_out_min_C | 46.35236 |
| outlet_spread_K | 10.35441 |
| rack_dp_Pa | 80405.53 |
| system_dp_Pa | 80405.53 |
| rack_flow_LPM | 120 |
| heat_W | 115560 |
| T_return_C | 54.36282 |
| rack_deltaT_K | 14.36282 |
| pump_hydraulic_W | 160.8111 |
| pump_electrical_W | 268.0184 |
| header_volume_m3 | 0.004082814 |
| min_header_ID_m | 0.038 |
| max_header_ID_m | 0.038 |
| max_header_velocity_m_s | 1.778106 |
| resolved_fluid_volume_m3 | 0.005694451 |
| minimum_normalized_margin | 0.07232227 |
| minimum_screening_margin | -0.03533867 |
| T_junction_upper_max_C | 80.70677 |
...
| --- | --- | --- | --- |
| coldplates | 44654.93 | 44.655 | 55.54 |
| qdcs | 16871.13 | 16.871 | 20.98 |
| tubing | 8731.90 | 8.732 | 10.86 |
| fittings | 6417.98 | 6.418 | 7.98 |
| valves | 458.43 | 0.458 | 0.57 |
| restrictions | 0.00 | 0.000 | 0.00 |
| orifices | 0.00 | 0.000 | 0.00 |
| header_friction | 834.99 | 0.835 | 1.04 |
| header_minor | 2359.23 | 2.359 | 2.93 |
| hydrostatic_net | 76.94 | 0.077 | 0.10 |
...
| --- | --- | --- | --- | --- | --- |
| C01 | 5800.0 | 5.2859 | 6.0228 | 56.356 | 16.356 |
| C02 | 5800.0 | 5.2742 | 6.0228 | 56.392 | 16.392 |
| C03 | 5800.0 | 5.2635 | 6.0228 | 56.426 | 16.426 |
| C04 | 5800.0 | 5.2537 | 6.0228 | 56.456 | 16.456 |
| C05 | 5800.0 | 5.2449 | 6.0228 | 56.484 | 16.484 |
| C06 | 5800.0 | 5.2368 | 6.0228 | 56.509 | 16.509 |
| C07 | 5800.0 | 5.2296 | 6.0228 | 56.532 | 16.532 |
| C08 | 5800.0 | 5.2232 | 6.0228 | 56.552 | 16.552 |
| C09 | 5800.0 | 5.2175 | 6.0228 | 56.570 | 16.570 |
| S01 | 1240.0 | 2.9173 | 1.2876 | 46.352 | 6.352 |
| S02 | 1240.0 | 2.9147 | 1.2876 | 46.358 | 6.358 |
| S03 | 1240.0 | 2.9123 | 1.2876 | 46.363 | 6.363 |
| S04 | 1240.0 | 2.9101 | 1.2876 | 46.368 | 6.368 |
| S05 | 1240.0 | 2.9080 | 1.2876 | 46.373 | 6.373 |
| S06 | 1240.0 | 2.9061 | 1.2876 | 46.377 | 6.377 |
| S07 | 1240.0 | 2.9044 | 1.2876 | 46.381 | 6.381 |
| S08 | 1240.0 | 2.9028 | 1.2876 | 46.384 | 6.384 |
| S09 | 1240.0 | 2.9014 | 1.2876 | 46.387 | 6.387 |
| C10 | 5800.0 | 5.1817 | 6.0228 | 56.684 | 16.684 |
| C11 | 5800.0 | 5.1799 | 6.0228 | 56.690 | 16.690 |
| C12 | 5800.0 | 5.1784 | 6.0228 | 56.695 | 16.695 |
| C13 | 5800.0 | 5.1772 | 6.0228 | 56.698 | 16.698 |
| C14 | 5800.0 | 5.1763 | 6.0228 | 56.701 | 16.701 |
| C15 | 5800.0 | 5.1756 | 6.0228 | 56.703 | 16.703 |
| C16 | 5800.0 | 5.1751 | 6.0228 | 56.705 | 16.705 |
| C17 | 5800.0 | 5.1748 | 6.0228 | 56.706 | 16.706 |
| C18 | 5800.0 | 5.1745 | 6.0228 | 56.707 | 16.707 |

# Pump requirements
Rack 80.406 kPa; system 80.406 kPa; hydraulic 160.81 W; electrical 268.02 W.
...
| required_UA_W_K | 21176.94760385624 |
| heat_balance_residual_W | -1.8917489796876907e-10 |
| TCS_capacity_rate_ratio | 0.9537883114410813 |
| rating_coolant | PG25 |
| approach_K | 4.0 |
| HX_available_W_per_rack | 115408.38568437085 |
| effectiveness_required | 0.7821685714554165 |
| hot_end_pinch_K | 7.230690349573479 |
...
| --- | --- | --- | --- | --- | --- |
| CDU_external_head | 34594.5 | Pa | True | False | Published nominal head point, not a measured pump envelope. |
| pump_curve | 34594.5 | Pa | True | False | Assumed shutoff parabola; manufacturer curve unavailable. |
...
| return_temperature | 10.6372 | K | True | True | Physical condition or explicitly configured design requirement. |
| branch_outlet | 8.29323 | K | True | True | Physical condition or explicitly configured design requirement. |
| minimum_thermal_flow | 0.0294187 | kg/s | True | True | Physical condition or explicitly configured design requirement. |
| header_velocity | 1.22189 | m/s | True | True | Physical condition or explicitly configured design requirement. |
...
| HX_capacity | -151.614 | W | False | False | Heuristic rating scaling, not a measured HX capacity map. |
...
| HX_hot_pinch | 7.23059 | K | True | True | Physical condition or explicitly configured design requirement. |
...
| chip_assumed_target | -0.706773 | K | False | False | Assumed resistance and 80°C design target; not a verified hardware limit. |
...
| nfev | 377 |
| temperature_error_K | 7.450640219985871e-05 |
| flow_relative_error | 2.7491512665697274e-08 |
| converged | True |
...
| --- | --- | --- | --- | --- |
| C01 | GPU | 68.36 | 80.36 | -0.36 |
| C01 | CPU | 66.36 | 76.36 | 3.64 |
| C02 | GPU | 68.39 | 80.39 | -0.39 |
| C02 | CPU | 66.39 | 76.39 | 3.61 |
| C03 | GPU | 68.43 | 80.43 | -0.43 |
| C03 | CPU | 66.43 | 76.43 | 3.57 |
| C04 | GPU | 68.46 | 80.46 | -0.46 |
| C04 | CPU | 66.46 | 76.46 | 3.54 |
| C05 | GPU | 68.48 | 80.48 | -0.48 |
| C05 | CPU | 66.48 | 76.48 | 3.52 |
| C06 | GPU | 68.51 | 80.51 | -0.51 |
| C06 | CPU | 66.51 | 76.51 | 3.49 |
| C07 | GPU | 68.53 | 80.53 | -0.53 |
| C07 | CPU | 66.53 | 76.53 | 3.47 |
| C08 | GPU | 68.55 | 80.55 | -0.55 |
| C08 | CPU | 66.55 | 76.55 | 3.45 |
| C09 | GPU | 68.57 | 80.57 | -0.57 |
| C09 | CPU | 66.57 | 76.57 | 3.43 |
| S01 | NVSwitch | 55.65 | 68.05 | 11.95 |
| S02 | NVSwitch | 55.66 | 68.06 | 11.94 |
| S03 | NVSwitch | 55.66 | 68.06 | 11.94 |
| S04 | NVSwitch | 55.67 | 68.07 | 11.93 |
| S05 | NVSwitch | 55.67 | 68.07 | 11.93 |
| S06 | NVSwitch | 55.68 | 68.08 | 11.92 |
| S07 | NVSwitch | 55.68 | 68.08 | 11.92 |
| S08 | NVSwitch | 55.68 | 68.08 | 11.92 |
| S09 | NVSwitch | 55.69 | 68.09 | 11.91 |
| C10 | GPU | 68.68 | 80.68 | -0.68 |
| C10 | CPU | 66.68 | 76.68 | 3.32 |
| C11 | GPU | 68.69 | 80.69 | -0.69 |
| C11 | CPU | 66.69 | 76.69 | 3.31 |
| C12 | GPU | 68.69 | 80.69 | -0.69 |
| C12 | CPU | 66.69 | 76.69 | 3.31 |
| C13 | GPU | 68.7 | 80.7 | -0.7 |
| C13 | CPU | 66.7 | 76.7 | 3.3 |
| C14 | GPU | 68.7 | 80.7 | -0.7 |
| C14 | CPU | 66.7 | 76.7 | 3.3 |
| C15 | GPU | 68.7 | 80.7 | -0.7 |
| C15 | CPU | 66.7 | 76.7 | 3.3 |
| C16 | GPU | 68.7 | 80.7 | -0.7 |
| C16 | CPU | 66.7 | 76.7 | 3.3 |
| C17 | GPU | 68.71 | 80.71 | -0.71 |
| C17 | CPU | 66.71 | 76.71 | 3.29 |
| C18 | GPU | 68.71 | 80.71 | -0.71 |
| C18 | CPU | 66.71 | 76.71 | 3.29 |
