...
| minimum_normalized_margin | 0.07692308 |
...
| Quantity | Value |
| --- | --- |
| FWS_return_C | 41.56614018065693 |
| FWS_supply_C | 36 |
| FWS_flow_LPM | 300 |
| FWS_deltaT_K | 5.56614018065693 |
| required_flow_LPM | 139.15059989265876 |
| entered_available_capacity_W | 500000 |
| entered_UA_W_K | 50000 |
| design_deltaT_K | 12.0 |
| minimum_hot_pinch_K | 0.0 |
| maximum_FWS_supply_C | 36 |
| required_UA_W_K | 15745.650248243655 |
| heat_balance_residual_W | 1.0186340659856796e-10 |
| TCS_capacity_rate_ratio | 1.0 |
| rating_coolant | PG25 |
| approach_K | 4.0 |
| HX_available_W_per_rack | 121000.0 |
| effectiveness_required | 0.77434812337556 |
| hot_end_pinch_K | 12.160280090411163 |
...
| --- | --- | --- | --- | --- | --- |
| CDU_external_head | 35166.1 | Pa | True | False | Published nominal head point, not a measured pump envelope. |
| pump_curve | 35166.1 | Pa | True | False | Assumed shutoff parabola; manufacturer curve unavailable. |
...
| branch_outlet | 9.03 | K | True | True | Physical condition or explicitly configured design requirement. |
| minimum_thermal_flow | 0.0318399 | kg/s | True | True | Physical condition or explicitly configured design requirement. |
...
| HX_hot_pinch | 12.1602 | K | True | True | Physical condition or explicitly configured design requirement. |
| FWS_design_temperature_rise | 6.43386 | K | True | True | Physical condition or explicitly configured design requirement. |
| FWS_return | 18.4339 | K | True | True | Physical condition or explicitly configured design requirement. |
| facility_available_duty | 384440 | W | True | True | Physical condition or explicitly configured design requirement. |
| HX_user_UA | 34254.3 | W/K | True | True | Physical condition or explicitly configured design requirement. |
| chip_assumed_target | 0.0300042 | K | True | False | Assumed resistance and 80°C design target; not a verified hardware limit. |
