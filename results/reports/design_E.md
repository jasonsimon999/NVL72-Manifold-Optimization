# Design E: minimum-head exact location balance at D geometry

# Configuration
```yaml
name: 'Design E: minimum-head exact location balance at D geometry'
rack:
  compute_trays: 18
  switch_trays: 9
  layout:
...
branches:
  ...
  overrides:
    C01:
      restriction_K: 446842.5835523719
    C02:
      restriction_K: 402204.3364475626
    C03:
      restriction_K: 361497.1677564726
    C04:
      restriction_K: 324590.6538981123
    C05:
      restriction_K: 291347.41663105093
    C06:
      restriction_K: 261622.8389899122
    C07:
      restriction_K: 235264.76513195317
    C08:
      restriction_K: 212113.18202959216
    C09:
      restriction_K: 191999.88038415037
    S01:
      restriction_K: 185119243.536782
    S02:
      restriction_K: 184750956.51907685
    S03:
      restriction_K: 184391846.10182866
    S04:
      restriction_K: 184041933.7740585
    S05:
      restriction_K: 183701237.7209276
    S06:
      restriction_K: 183369772.65735984
    S07:
      restriction_K: 183047549.65469345
    S08:
      restriction_K: 182734575.96005148
    S09:
      restriction_K: 182430854.80810693
    C10:
      restriction_K: 38409.12165478485
    C11:
      restriction_K: 27466.069484744472
    C12:
      restriction_K: 18805.137660441553
    C13:
      restriction_K: 12179.779530179376
    C14:
      restriction_K: 7330.390282516469
    C15:
      restriction_K: 3983.310432017072
    C16:
      restriction_K: 1849.5015307711076
    C17:
      restriction_K: 622.5729686469924
    C18:
      restriction_K: 0.0
loss_coefficients:
  header:
...
| M_flow | 1.065421 |
| CV_flow | 0.5022441 |
| M_thermal | 6.652389e-12 |
| RMS_target_error | 3.308589e-12 |
| max_abs_target_error | 5.713906e-12 |
| zero_load_flow_fraction | 0 |
| T_out_max_C | 53.72718 |
| T_out_min_C | 53.72718 |
| outlet_spread_K | 9.117684e-11 |
| rack_dp_Pa | 107672.7 |
| system_dp_Pa | 107672.7 |
| rack_flow_LPM | 119.9934 |
| heat_W | 115560 |
| T_return_C | 53.72718 |
| rack_deltaT_K | 13.72718 |
| pump_hydraulic_W | 215.3336 |
| pump_electrical_W | 358.8893 |
| header_volume_m3 | 0.00384294 |
| min_header_ID_m | 0.03526016 |
| max_header_ID_m | 0.03848804 |
| max_header_velocity_m_s | 1.735967 |
| resolved_fluid_volume_m3 | 0.005454577 |
...
| --- | --- | --- | --- |
| coldplates | 53009.95 | 53.010 | 49.23 |
| qdcs | 22012.16 | 22.012 | 20.44 |
| tubing | 10185.48 | 10.185 | 9.46 |
| fittings | 7862.21 | 7.862 | 7.30 |
| valves | 561.59 | 0.562 | 0.52 |
| restrictions | 9994.40 | 9.994 | 9.28 |
| header_friction | 809.58 | 0.810 | 0.75 |
| header_minor | 3174.54 | 3.175 | 2.95 |
...
| --- | --- | --- | --- | --- | --- |
| C01 | 5800.0 | 6.0225 | 6.0225 | 53.727 | 13.727 |
| C02 | 5800.0 | 6.0225 | 6.0225 | 53.727 | 13.727 |
| C03 | 5800.0 | 6.0225 | 6.0225 | 53.727 | 13.727 |
| C04 | 5800.0 | 6.0225 | 6.0225 | 53.727 | 13.727 |
| C05 | 5800.0 | 6.0225 | 6.0225 | 53.727 | 13.727 |
| C06 | 5800.0 | 6.0225 | 6.0225 | 53.727 | 13.727 |
| C07 | 5800.0 | 6.0225 | 6.0225 | 53.727 | 13.727 |
| C08 | 5800.0 | 6.0225 | 6.0225 | 53.727 | 13.727 |
| C09 | 5800.0 | 6.0225 | 6.0225 | 53.727 | 13.727 |
| S01 | 1240.0 | 1.2876 | 1.2876 | 53.727 | 13.727 |
| S02 | 1240.0 | 1.2876 | 1.2876 | 53.727 | 13.727 |
| S03 | 1240.0 | 1.2876 | 1.2876 | 53.727 | 13.727 |
| S04 | 1240.0 | 1.2876 | 1.2876 | 53.727 | 13.727 |
| S05 | 1240.0 | 1.2876 | 1.2876 | 53.727 | 13.727 |
| S06 | 1240.0 | 1.2876 | 1.2876 | 53.727 | 13.727 |
| S07 | 1240.0 | 1.2876 | 1.2876 | 53.727 | 13.727 |
| S08 | 1240.0 | 1.2876 | 1.2876 | 53.727 | 13.727 |
| S09 | 1240.0 | 1.2876 | 1.2876 | 53.727 | 13.727 |
| C10 | 5800.0 | 6.0225 | 6.0225 | 53.727 | 13.727 |
| C11 | 5800.0 | 6.0225 | 6.0225 | 53.727 | 13.727 |
| C12 | 5800.0 | 6.0225 | 6.0225 | 53.727 | 13.727 |
| C13 | 5800.0 | 6.0225 | 6.0225 | 53.727 | 13.727 |
| C14 | 5800.0 | 6.0225 | 6.0225 | 53.727 | 13.727 |
| C15 | 5800.0 | 6.0225 | 6.0225 | 53.727 | 13.727 |
| C16 | 5800.0 | 6.0225 | 6.0225 | 53.727 | 13.727 |
| C17 | 5800.0 | 6.0225 | 6.0225 | 53.727 | 13.727 |
| C18 | 5800.0 | 6.0225 | 6.0225 | 53.727 | 13.727 |

# Pump requirements
Rack 107.673 kPa; system 107.673 kPa; hydraulic 215.33 W; electrical 358.89 W.
...
| FWS_supply_C | 36 |
| approach_K | 4.0 |
| HX_available_W_per_rack | 120993.320467403 |
| effectiveness_required | 0.7743577532283322 |
| hot_end_pinch_K | 6.595043985237396 |
...
| --- | --- | --- | --- |
| CDU_external_head | 7327.27 | Pa | True |
| pump_curve | 7332.24 | Pa | True |
| rack_flow | 10.0066 | LPM | True |
| CDU_aggregate_flow | 0.00662433 | LPM | True |
| supply_temperature | 5 | K | True |
| return_temperature | 11.2728 | K | True |
| branch_outlet | 11.2728 | K | True |
| minimum_thermal_flow | 0.0098863 | kg/s | True |
| header_velocity | 1.26403 | m/s | True |
| minimum_diameter | 0.0202602 | m | True |
| maximum_diameter | 0.011512 | m | True |
| HX_capacity | 5433.32 | W | True |
| HX_approach | 0 | K | True |
| HX_hot_pinch | 6.59504 | K | True |
...
| energy_relative_error | 2.266653462362438e-15 |
| pressure_residual_Pa | 4.3655745685100555e-11 |
| property_iterations | 12 |
| nfev | 560 |
| temperature_error_K | 4.719373612260824e-05 |
| flow_relative_error | 8.124228820024751e-09 |
| converged | True |
