# Design A: constant diameter optimization

# Configuration
```yaml
name: 'Design A: constant diameter optimization'
rack:
  compute_trays: 18
  switch_trays: 9
  layout:
...
geometry:
  ...
  supply:
    profile: constant
    inlet_m: 0.02923316227850788
    outlet_m: 0.02923316227850788
    exponent: 1.0
    pieces_m:
    - 0.038
    - 0.032
...
| CV_flow | 0.2474469 |
| M_thermal | 1.069361 |
| RMS_target_error | 0.728901 |
| max_abs_target_error | 1.267769 |
| zero_load_flow_fraction | 0 |
| T_out_max_C | 56.16935 |
| T_out_min_C | 46.05846 |
| outlet_spread_K | 10.11089 |
| rack_dp_Pa | 86209.15 |
| system_dp_Pa | 86209.15 |
| rack_flow_LPM | 120 |
| heat_W | 115560 |
| T_return_C | 53.72642 |
| rack_deltaT_K | 13.72642 |
| pump_hydraulic_W | 172.4183 |
| pump_electrical_W | 287.3638 |
| header_volume_m3 | 0.002416262 |
| min_header_ID_m | 0.02923316 |
| max_header_ID_m | 0.02923316 |
| max_header_velocity_m_s | 2.999996 |
| resolved_fluid_volume_m3 | 0.004027899 |
...
| --- | --- | --- | --- |
| coldplates | 44462.16 | 44.462 | 51.57 |
| qdcs | 16824.91 | 16.825 | 19.52 |
| tubing | 8529.86 | 8.530 | 9.89 |
| fittings | 6405.05 | 6.405 | 7.43 |
| valves | 457.50 | 0.458 | 0.53 |
| restrictions | 0.00 | 0.000 | 0.00 |
| header_friction | 2823.13 | 2.823 | 3.27 |
| header_minor | 6643.72 | 6.644 | 7.71 |
...
| --- | --- | --- | --- | --- | --- |
| C01 | 5800.0 | 5.4339 | 6.0228 | 55.211 | 15.211 |
| C02 | 5800.0 | 5.3996 | 6.0228 | 55.308 | 15.308 |
| C03 | 5800.0 | 5.3681 | 6.0228 | 55.397 | 15.397 |
| C04 | 5800.0 | 5.3394 | 6.0228 | 55.480 | 15.480 |
| C05 | 5800.0 | 5.3133 | 6.0228 | 55.556 | 15.556 |
| C06 | 5800.0 | 5.2897 | 6.0228 | 55.625 | 15.625 |
| C07 | 5800.0 | 5.2685 | 6.0228 | 55.688 | 15.688 |
| C08 | 5800.0 | 5.2496 | 6.0228 | 55.745 | 15.745 |
| C09 | 5800.0 | 5.2328 | 6.0228 | 55.795 | 15.795 |
| S01 | 1240.0 | 2.9201 | 1.2876 | 46.058 | 6.058 |
| S02 | 1240.0 | 2.9124 | 1.2876 | 46.074 | 6.074 |
| S03 | 1240.0 | 2.9054 | 1.2876 | 46.089 | 6.089 |
| S04 | 1240.0 | 2.8989 | 1.2876 | 46.103 | 6.103 |
| S05 | 1240.0 | 2.8929 | 1.2876 | 46.115 | 6.115 |
| S06 | 1240.0 | 2.8874 | 1.2876 | 46.127 | 6.127 |
| S07 | 1240.0 | 2.8825 | 1.2876 | 46.137 | 6.137 |
| S08 | 1240.0 | 2.8780 | 1.2876 | 46.147 | 6.147 |
| S09 | 1240.0 | 2.8739 | 1.2876 | 46.156 | 6.156 |
| C10 | 5800.0 | 5.1294 | 6.0228 | 56.113 | 16.113 |
| C11 | 5800.0 | 5.1242 | 6.0228 | 56.129 | 16.129 |
| C12 | 5800.0 | 5.1201 | 6.0228 | 56.142 | 16.142 |
| C13 | 5800.0 | 5.1170 | 6.0228 | 56.152 | 16.152 |
| C14 | 5800.0 | 5.1147 | 6.0228 | 56.159 | 16.159 |
| C15 | 5800.0 | 5.1132 | 6.0228 | 56.164 | 16.164 |
| C16 | 5800.0 | 5.1122 | 6.0228 | 56.167 | 16.167 |
| C17 | 5800.0 | 5.1117 | 6.0228 | 56.168 | 16.168 |
| C18 | 5800.0 | 5.1114 | 6.0228 | 56.169 | 16.169 |

# Pump requirements
Rack 86.209 kPa; system 86.209 kPa; hydraulic 172.42 W; electrical 287.36 W.
...
| --- | --- | --- | --- |
| CDU_external_head | 28790.9 | Pa | True |
| pump_curve | 28790.9 | Pa | True |
| rack_flow | 10 | LPM | True |
| CDU_aggregate_flow | 0 | LPM | True |
| supply_temperature | 5 | K | True |
| return_temperature | 11.2736 | K | True |
| branch_outlet | 8.83065 | K | True |
| minimum_thermal_flow | 0.0307531 | kg/s | True |
| header_velocity | 4.48736e-06 | m/s | True |
| minimum_diameter | 0.0142332 | m | True |
| maximum_diameter | 0.0207668 | m | True |
...
| nfev | 378 |
| temperature_error_K | 6.647346970112267e-05 |
| flow_relative_error | 3.132665907785278e-08 |
| converged | True |
