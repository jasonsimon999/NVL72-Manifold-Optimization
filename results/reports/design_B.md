# Design B: tapered headers

# Configuration
```yaml
name: 'Design B: tapered headers'
rack:
  compute_trays: 18
  switch_trays: 9
  layout:
...
geometry:
  ...
  supply:
    profile: power
    inlet_m: 0.029135574607869096
    outlet_m: 0.029091137603597442
    exponent: 1.0
    pieces_m:
    - 0.038
    - 0.032
  ...
  return:
    profile: power
    inlet_m: 0.029223529358357786
    outlet_m: 0.029235632355577898
    exponent: 1.0
    pieces_m:
    - 0.025
    - 0.032
...
| CV_flow | 0.2494891 |
| M_thermal | 1.076152 |
| RMS_target_error | 0.7254489 |
| max_abs_target_error | 1.268998 |
| zero_load_flow_fraction | 0 |
| T_out_max_C | 56.2849 |
| T_out_min_C | 46.05518 |
| outlet_spread_K | 10.22972 |
| rack_dp_Pa | 88852.58 |
| system_dp_Pa | 88852.58 |
| rack_flow_LPM | 120 |
| heat_W | 115560 |
| T_return_C | 53.72642 |
| rack_deltaT_K | 13.72642 |
| pump_hydraulic_W | 177.7052 |
| pump_electrical_W | 296.1753 |
| header_volume_m3 | 0.002406084 |
| min_header_ID_m | 0.02909114 |
| max_header_ID_m | 0.02923563 |
| max_header_velocity_m_s | 2.999974 |
| resolved_fluid_volume_m3 | 0.004017721 |
...
| --- | --- | --- | --- |
| coldplates | 44496.66 | 44.497 | 50.08 |
| qdcs | 16853.82 | 16.854 | 18.97 |
| tubing | 8537.65 | 8.538 | 9.61 |
| fittings | 6411.86 | 6.412 | 7.22 |
| valves | 457.99 | 0.458 | 0.52 |
| restrictions | 0.00 | 0.000 | 0.00 |
| header_friction | 2825.64 | 2.826 | 3.18 |
| header_minor | 9206.15 | 9.206 | 10.36 |
| hydrostatic_net | 62.82 | 0.063 | 0.07 |
...
| --- | --- | --- | --- | --- | --- |
| C01 | 5800.0 | 5.5199 | 6.0228 | 54.975 | 14.975 |
| C02 | 5800.0 | 5.4723 | 6.0228 | 55.105 | 15.105 |
| C03 | 5800.0 | 5.4286 | 6.0228 | 55.226 | 15.226 |
| C04 | 5800.0 | 5.3887 | 6.0228 | 55.339 | 15.339 |
| C05 | 5800.0 | 5.3525 | 6.0228 | 55.442 | 15.442 |
| C06 | 5800.0 | 5.3198 | 6.0228 | 55.537 | 15.537 |
| C07 | 5800.0 | 5.2905 | 6.0228 | 55.623 | 15.623 |
| C08 | 5800.0 | 5.2643 | 6.0228 | 55.700 | 15.700 |
| C09 | 5800.0 | 5.2412 | 6.0228 | 55.770 | 15.770 |
| S01 | 1240.0 | 2.9217 | 1.2876 | 46.055 | 6.055 |
| S02 | 1240.0 | 2.9111 | 1.2876 | 46.077 | 6.077 |
| S03 | 1240.0 | 2.9014 | 1.2876 | 46.097 | 6.097 |
| S04 | 1240.0 | 2.8924 | 1.2876 | 46.116 | 6.116 |
| S05 | 1240.0 | 2.8842 | 1.2876 | 46.134 | 6.134 |
| S06 | 1240.0 | 2.8767 | 1.2876 | 46.150 | 6.150 |
| S07 | 1240.0 | 2.8699 | 1.2876 | 46.164 | 6.164 |
| S08 | 1240.0 | 2.8638 | 1.2876 | 46.177 | 6.177 |
| S09 | 1240.0 | 2.8582 | 1.2876 | 46.189 | 6.189 |
| C10 | 5800.0 | 5.0990 | 6.0228 | 56.208 | 16.208 |
| C11 | 5800.0 | 5.0919 | 6.0228 | 56.231 | 16.231 |
| C12 | 5800.0 | 5.0864 | 6.0228 | 56.249 | 16.249 |
| C13 | 5800.0 | 5.0823 | 6.0228 | 56.262 | 16.262 |
| C14 | 5800.0 | 5.0793 | 6.0228 | 56.271 | 16.271 |
| C15 | 5800.0 | 5.0773 | 6.0228 | 56.278 | 16.278 |
| C16 | 5800.0 | 5.0760 | 6.0228 | 56.282 | 16.282 |
| C17 | 5800.0 | 5.0753 | 6.0228 | 56.284 | 16.284 |
| C18 | 5800.0 | 5.0750 | 6.0228 | 56.285 | 16.285 |

# Pump requirements
Rack 88.853 kPa; system 88.853 kPa; hydraulic 177.71 W; electrical 296.18 W.
...
| --- | --- | --- | --- |
| CDU_external_head | 26147.4 | Pa | True |
| pump_curve | 26147.4 | Pa | True |
| rack_flow | 10 | LPM | True |
| CDU_aggregate_flow | 0 | LPM | True |
| supply_temperature | 5 | K | True |
| return_temperature | 11.2736 | K | True |
| branch_outlet | 8.7151 | K | True |
| minimum_thermal_flow | 0.0301353 | kg/s | True |
| header_velocity | 2.61305e-05 | m/s | True |
| minimum_diameter | 0.0140911 | m | True |
| maximum_diameter | 0.0207644 | m | True |
...
| nfev | 378 |
| temperature_error_K | 6.358730939837187e-05 |
| flow_relative_error | 3.171623574793698e-08 |
| converged | True |
