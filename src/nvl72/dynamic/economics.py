...
def compare(fixed, active, s, count, total_count=27):
    ...
    if count==0:cap_active=cap_fixed
    ...
    active_maintenance=costs['active_maintenance'] if count else costs['fixed_maintenance']
    maintenance=active_maintenance-costs['fixed_maintenance']
    ...
    return dict(fixed_capex=cap_fixed,active_capex=cap_active,incremental_capex=incremental,
                ...
                annual_active_cost=annual_active*s['electricity_per_kWh']+active_maintenance,
