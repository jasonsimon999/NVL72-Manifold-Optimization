...
st.page_link('pages/1_Dynamic_Flow_Control.py', label='Open Dynamic Flow Control →', icon='🔄', help='Compare the optimized passive fixed-orifice manifold with active variable branch control.')
with st.sidebar:
    st.markdown('## Navigation')
    st.page_link('dashboard.py', label='Fixed-orifice manifold', icon='🎛️')
    st.page_link('pages/1_Dynamic_Flow_Control.py', label='Dynamic flow control', icon='🔄')
